...
rule content_ja_language_nsfw_2 {
  ...
  strings:
    ...
    $wide = "\x67\x00\x20\x00\xb9\x30\x00\xdd\x30\x00\xc3\x30\x00\xc8\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_3 {
  ...
  strings:
    ...
    $wide = "\x73\x00\x20\x00\x06\xff\x00\x20\x00\x6d\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_5 {
  ...
  strings:
    ...
    $wide = "\x73\x00\x6d\x00\x73\x59\x00\x8b\x73\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_10 {
  ...
  strings:
    ...
    $wide = "\x4a\x30\x00\x3b\x5c\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_11 {
  ...
  strings:
    ...
    $wide = "\x6a\x30\x00\x81\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_12 {
  ...
  strings:
    ...
    $wide = "\xb0\x30\x00\xed\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_13 {
  ...
  strings:
    ...
    $wide = "\xc7\x30\x00\xd6\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_14 {
  ...
  strings:
    ...
    $wide = "\xdb\x30\x00\xe2\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_15 {
  ...
  strings:
    ...
    $wide = "\x21\x4e\x00\x00\x52\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_16 {
  ...
  strings:
    ...
    $wide = "\x21\x4e\x00\x27\x60\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_17 {
  ...
  strings:
    ...
    $wide = "\x71\x4e\x00\xa4\x4e\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_18 {
  ...
  strings:
    ...
    $wide = "\x73\x4e\x00\x96\x99\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_19 {
  ...
  strings:
    ...
    $wide = "\x8c\x4e\x00\x74\x7a\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_20 {
  ...
  strings:
    ...
    $wide = "\xba\x4e\x00\xbb\x59\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_21 {
  ...
  strings:
    ...
    $wide = "\xba\x4e\x00\x2e\x7a\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_22 {
  ...
  strings:
    ...
    $wide = "\x43\x52\x00\xdb\x6b\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_23 {
  ...
  strings:
    ...
    $wide = "\x74\x56\x00\xfa\x51\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_24 {
  ...
  strings:
    ...
    $wide = "\x09\x59\x00\x4b\x61\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_25 {
  ...
  strings:
    ...
    $wide = "\x22\x59\x00\xbe\x7c\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_26 {
  ...
  strings:
    ...
    $wide = "\x73\x59\x00\xc5\x88\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_27 {
  ...
  strings:
    ...
    $wide = "\x74\x59\x00\xb7\x96\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_29 {
  ...
  strings:
    ...
    $wide = "\xa6\x5b\x00\x98\x5b\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_32 {
  ...
  strings:
    ...
    $wide = "\xe8\x5d\x00\x39\x68\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_35 {
  ...
  strings:
    ...
    $wide = "\xf7\x62\x00\x4f\x55\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_36 {
  ...
  strings:
    ...
    $wide = "\x3f\x63\x00\x65\x51\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_37 {
  ...
  strings:
    ...
    $wide = "\x2f\x65\x00\x4d\x91\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_39 {
  ...
  strings:
    ...
    $wide = "\x63\x73\x00\xe6\x59\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_40 {
  ...
  strings:
    ...
    $wide = "\xf4\x76\x00\x78\x81\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_41 {
  ...
  strings:
    ...
    $wide = "\xbe\x7c\x00\xb2\x6d\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_42 {
  ...
  strings:
    ...
    $wide = "\xde\x7c\x00\xbf\x4f\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_43 {
  ...
  strings:
    ...
    $wide = "\xca\x7d\x00\x1b\x7e\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_44 {
  ...
  strings:
    ...
    $wide = "\x1b\x7e\x00\x8a\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_45 {
  ...
  strings:
    ...
    $wide = "\x9b\x80\x00\x80\x95\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_46 {
  ...
  strings:
    ...
    $wide = "\x31\x81\x00\x63\x88\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_47 {
  ...
  strings:
    ...
    $wide = "\x97\x89\x00\x4d\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_48 {
  ...
  strings:
    ...
    $wide = "\x98\x8a\x00\xd1\x60\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_49 {
  ...
  strings:
    ...
    $wide = "\x2a\x8f\x00\xe6\x59\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_50 {
  ...
  strings:
    ...
    $wide = "\x70\x96\x00\xdb\x6b\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_51 {
  ...
  strings:
    ...
    $wide = "\x4a\x30\x00\x57\x30\x00\x8a\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_52 {
  ...
  strings:
    ...
    $wide = "\x57\x30\x00\x70\x30\x00\x8a\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_53 {
  ...
  strings:
    ...
    $wide = "\x61\x30\x00\x93\x30\x00\x53\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_54 {
  ...
  strings:
    ...
    $wide = "\x7e\x30\x00\x93\x30\x00\x53\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_55 {
  ...
  strings:
    ...
    $wide = "\x84\x30\x00\x4a\x30\x00\x44\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_56 {
  ...
  strings:
    ...
    $wide = "\xa2\x30\x00\xca\x30\x00\xeb\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_57 {
  ...
  strings:
    ...
    $wide = "\xa8\x30\x00\xc3\x30\x00\xc1\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_58 {
  ...
  strings:
    ...
    $wide = "\xaa\x30\x00\xab\x30\x00\xde\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_59 {
  ...
  strings:
    ...
    $wide = "\xaa\x30\x00\xb7\x30\x00\xea\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_60 {
  ...
  strings:
    ...
    $wide = "\xab\x30\x00\xf3\x30\x00\xc8\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_61 {
  ...
  strings:
    ...
    $wide = "\xcb\x30\x00\xac\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_62 {
  ...
  strings:
    ...
    $wide = "\xcc\x30\x00\xfc\x30\x00\xc9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_63 {
  ...
  strings:
    ...
    $wide = "\xd3\x30\x00\xc3\x30\x00\xc1\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_64 {
  ...
  strings:
    ...
    $wide = "\xd5\x30\x00\xc3\x30\x00\xaf\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_65 {
  ...
  strings:
    ...
    $wide = "\xda\x30\x00\xcb\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_66 {
  ...
  strings:
    ...
    $wide = "\xdd\x30\x00\xeb\x30\x00\xce\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_67 {
  ...
  strings:
    ...
    $wide = "\xe9\x30\x00\xd0\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_68 {
  ...
  strings:
    ...
    $wide = "\xec\x30\x00\xa4\x30\x00\xd7\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_69 {
  ...
  strings:
    ...
    $wide = "\x2d\x4e\x00\xfa\x51\x00\x57\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_70 {
  ...
  strings:
    ...
    $wide = "\xf2\x58\x00\x25\x66\x00\x66\x5a\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_71 {
  ...
  strings:
    ...
    $wide = "\x27\x59\x00\x70\x96\x00\x07\x55\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_73 {
  ...
  strings:
    ...
    $wide = "\x73\x59\x00\x8b\x73\x00\xd8\x69\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_74 {
  ...
  strings:
    ...
    $wide = "\x37\x5f\x00\xe6\x59\x00\xaf\x72\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_75 {
  ...
  strings:
    ...
    $wide = "\x8c\x5f\x00\xcc\x80\x00\x4d\x4f\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_76 {
  ...
  strings:
    ...
    $wide = "\x4b\x62\x00\xb3\x30\x00\xad\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_77 {
  ...
  strings:
    ...
    $wide = "\x63\x6b\x00\x38\x5e\x00\x4d\x4f\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_78 {
  ...
  strings:
    ...
    $wide = "\xba\x6b\x00\x57\x30\x00\xb9\x65\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_79 {
  ...
  strings:
    ...
    $wide = "\xdb\x6b\x00\xf1\x6d\x00\x44\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_80 {
  ...
  strings:
    ...
    $wide = "\x89\x73\x00\x6a\x30\x00\x81\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_81 {
  ...
  strings:
    ...
    $wide = "\x89\x73\x00\x10\x82\x00\x81\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_82 {
  ...
  strings:
    ...
    $wide = "\x1f\x75\x00\x96\x6b\x00\x68\x56\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_83 {
  ...
  strings:
    ...
    $wide = "\x9e\x8c\x00\xcd\x64\x00\x2f\x5e\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_84 {
  ...
  strings:
    ...
    $wide = "\x69\x97\x00\x91\x62\x00\x36\x52\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_85 {
  ...
  strings:
    ...
    $wide = "\x0e\x9a\x00\x0a\x4e\x00\x4d\x4f\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_86 {
  ...
  strings:
    ...
    $wide = "\x44\x30\x00\x5f\x30\x00\x5a\x30\x00\x89\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_87 {
  ...
  strings:
    ...
    $wide = "\x4a\x30\x00\x57\x30\x00\x63\x30\x00\x53\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_88 {
  ...
  strings:
    ...
    $wide = "\x4a\x30\x00\x63\x30\x00\x71\x30\x00\x44\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_89 {
  ...
  strings:
    ...
    $wide = "\x4a\x30\x00\x82\x30\x00\x89\x30\x00\x57\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_90 {
  ...
  strings:
    ...
    $wide = "\x75\x30\x00\x5f\x30\x00\x6a\x30\x00\x8a\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_91 {
  ...
  strings:
    ...
    $wide = "\x76\x30\x00\x63\x30\x00\x4b\x30\x00\x51\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_92 {
  ...
  strings:
    ...
    $wide = "\x84\x30\x00\x8a\x30\x00\x7e\x30\x00\x93\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_93 {
  ...
  strings:
    ...
    $wide = "\xaa\x30\x00\xc3\x30\x00\xd1\x30\x00\xa4\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_94 {
  ...
  strings:
    ...
    $wide = "\xaa\x30\x00\xca\x30\x00\xcb\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_95 {
  ...
  strings:
    ...
    $wide = "\xaa\x30\x00\xde\x30\x00\xf3\x30\x00\xb3\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_96 {
  ...
  strings:
    ...
    $wide = "\xb3\x30\x00\xab\x30\x00\xa4\x30\x00\xf3\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_97 {
  ...
  strings:
    ...
    $wide = "\xb4\x30\x00\xc3\x30\x00\xaf\x30\x00\xf3\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_98 {
  ...
  strings:
    ...
    $wide = "\xb9\x30\x00\xab\x30\x00\xc8\x30\x00\xed\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_99 {
  ...
  strings:
    ...
    $wide = "\xb9\x30\x00\xe9\x30\x00\xc3\x30\x00\xc8\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_100 {
  ...
  strings:
    ...
    $wide = "\xb9\x30\x00\xea\x30\x00\xc3\x30\x00\xc8\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_101 {
  ...
  strings:
    ...
    $wide = "\xbb\x30\x00\xc3\x30\x00\xaf\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_102 {
  ...
  strings:
    ...
    $wide = "\xbd\x30\x00\xc9\x30\x00\xdf\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_103 {
  ...
  strings:
    ...
    $wide = "\xc7\x30\x00\xa3\x30\x00\xc3\x30\x00\xaf\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_104 {
  ...
  strings:
    ...
    $wide = "\xc7\x30\x00\xa3\x30\x00\xeb\x30\x00\xc9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_105 {
  ...
  strings:
    ...
    $wide = "\xd1\x30\x00\xa4\x30\x00\xd1\x30\x00\xf3\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_106 {
  ...
  strings:
    ...
    $wide = "\xd5\x30\x00\xa1\x30\x00\xc3\x30\x00\xaf\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_107 {
  ...
  strings:
    ...
    $wide = "\xd5\x30\x00\xa3\x30\x00\xb9\x30\x00\xc8\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_109 {
  ...
  strings:
    ...
    $wide = "\xed\x30\x00\xea\x30\x00\xfc\x30\x00\xbf\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_110 {
  ...
  strings:
    ...
    $wide = "\xed\x30\x00\xfc\x30\x00\xbf\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_111 {
  ...
  strings:
    ...
    $wide = "\x21\x4e\x00\x27\x60\x00\x77\x51\x00\x09\x67\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_112 {
  ...
  strings:
    ...
    $wide = "\xc3\x52\x00\x77\x8d\x00\x59\x30\x00\x8b\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_113 {
  ...
  strings:
    ...
    $wide = "\x73\x59\x00\x50\x5b\x00\xd8\x9a\x00\x1f\x75\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_114 {
  ...
  strings:
    ...
    $wide = "\x73\x5e\x00\x4b\x62\x00\x53\x62\x00\x61\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_115 {
  ...
  strings:
    ...
    $wide = "\xba\x6b\x00\xba\x4e\x00\x8b\x4e\x00\xf6\x4e\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_116 {
  ...
  strings:
    ...
    $wide = "\xba\x6b\x00\xba\x4e\x00\xb9\x65\x00\xd5\x6c\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_117 {
  ...
  strings:
    ...
    $wide = "\x6e\x6f\x00\x39\x54\x00\x4d\x30\x00\x73\x59\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_118 {
  ...
  strings:
    ...
    $wide = "\xea\x81\x00\xf1\x5d\x00\x1b\x61\x00\x27\x60\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_119 {
  ...
  strings:
    ...
    $wide = "\xf8\x88\x00\x6e\x30\x00\x73\x59\x00\x27\x60\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_120 {
  ...
  strings:
    ...
    $wide = "\xb3\x8d\x00\xd5\x30\x00\xa7\x30\x00\xc1\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_121 {
  ...
  strings:
    ...
    $wide = "\xd1\x8f\x00\xaa\x89\x00\xf8\x76\x00\xe6\x59\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_122 {
  ...
  strings:
    ...
    $wide = "\xd7\x30\x00\xea\x30\x00\xf3\x30\x00\xb9\x30\x00\x20\x00\xa2\x30\x00\xeb\x30\x00\xd0\x30\x00\xfc\x30\x00\xc8\x30\x00\x20\x00\xd4\x30\x00\xa2\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_123 {
  ...
  strings:
    ...
    $wide = "\x7d\x30\x00\x63\x30\x00\x61\x30\x00\x83\x30\x00\x8a\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_124 {
  ...
  strings:
    ...
    $wide = "\xa2\x30\x00\xb9\x30\x00\xdb\x30\x00\xfc\x30\x00\xeb\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_125 {
  ...
  strings:
    ...
    $wide = "\xa4\x30\x00\xe9\x30\x00\xde\x30\x00\xc1\x30\x00\xaa\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_126 {
  ...
  strings:
    ...
    $wide = "\xa8\x30\x00\xb9\x30\x00\xb3\x30\x00\xfc\x30\x00\xc8\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_127 {
  ...
  strings:
    ...
    $wide = "\xaa\x30\x00\xfc\x30\x00\xac\x30\x00\xba\x30\x00\xe0\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_128 {
  ...
  strings:
    ...
    $wide = "\xaf\x30\x00\xea\x30\x00\xc8\x30\x00\xea\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_129 {
  ...
  strings:
    ...
    $wide = "\xb2\x30\x00\xa4\x30\x00\x6e\x30\x00\x37\x75\x00\x27\x60\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_130 {
  ...
  strings:
    ...
    $wide = "\xb2\x30\x00\xa4\x30\x00\xdc\x30\x00\xfc\x30\x00\xa4\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_131 {
  ...
  strings:
    ...
    $wide = "\xb5\x30\x00\xc7\x30\x00\xa3\x30\x00\xba\x30\x00\xe0\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_132 {
  ...
  strings:
    ...
    $wide = "\xbb\x30\x00\xaf\x30\x00\xb7\x30\x00\xfc\x30\x00\x6a\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_133 {
  ...
  strings:
    ...
    $wide = "\xc8\x30\x00\xc3\x30\x00\xd7\x30\x00\xec\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_134 {
  ...
  strings:
    ...
    $wide = "\xcd\x30\x00\xaa\x30\x00\xfb\x30\x00\xca\x30\x00\xc1\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_135 {
  ...
  strings:
    ...
    $wide = "\xcf\x30\x00\xfc\x30\x00\xc9\x30\x00\xb3\x30\x00\xa2\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_136 {
  ...
  strings:
    ...
    $wide = "\xd1\x30\x00\xf3\x30\x00\xc6\x30\x00\xa3\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_137 {
  ...
  strings:
    ...
    $wide = "\xd5\x30\x00\xa7\x30\x00\xe9\x30\x00\xc1\x30\x00\xaa\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_138 {
  ...
  strings:
    ...
    $wide = "\xd9\x30\x00\xa2\x30\x00\xd0\x30\x00\xc3\x30\x00\xaf\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_139 {
  ...
  strings:
    ...
    $wide = "\xdc\x30\x00\xf3\x30\x00\xc6\x30\x00\xfc\x30\x00\xb8\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_141 {
  ...
  strings:
    ...
    $wide = "\xec\x30\x00\xba\x30\x00\xd3\x30\x00\xa2\x30\x00\xf3\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_142 {
  ...
  strings:
    ...
    $wide = "\x50\x51\x00\xe5\x7a\x00\x27\x60\x00\x50\x86\x00\x85\x5f\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_143 {
  ...
  strings:
    ...
    $wide = "\x08\x54\x00\x0f\x61\x00\x6e\x30\x00\x27\x60\x00\xa4\x4e\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_144 {
  ...
  strings:
    ...
    $wide = "\x3f\x5c\x00\x53\x90\x00\xd7\x30\x00\xec\x30\x00\xa4\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_145 {
  ...
  strings:
    ...
    $wide = "\x7c\x5e\x00\x50\x51\x00\x27\x60\x00\x1b\x61\x00\x05\x80\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_146 {
  ...
  strings:
    ...
    $wide = "\x6e\x6f\x00\x39\x54\x00\x4d\x30\x00\x37\x75\x00\x27\x60\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_147 {
  ...
  strings:
    ...
    $wide = "\xde\x7c\x00\x3f\x5c\x00\x1b\x61\x00\x7d\x59\x00\xc7\x75\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_148 {
  ...
  strings:
    ...
    $wide = "\xb3\x8d\x00\x92\x30\x00\x83\x5e\x00\x52\x30\x00\x8b\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_149 {
  ...
  strings:
    ...
    $wide = "\xbb\x30\x00\xaf\x30\x00\xb7\x30\x00\xfc\x30\x00\x6a\x30\x00\x20\x00\x31\x00\x30\x00\x20\x00\xe3\x4e\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_150 {
  ...
  strings:
    ...
    $wide = "\x4a\x30\x00\x57\x30\x00\x8a\x30\x00\x6e\x30\x00\x42\x30\x00\x6a\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_151 {
  ...
  strings:
    ...
    $wide = "\xa2\x30\x00\xca\x30\x00\xea\x30\x00\xf3\x30\x00\xb0\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_153 {
  ...
  strings:
    ...
    $wide = "\xa8\x30\x00\xaf\x30\x00\xb9\x30\x00\xbf\x30\x00\xb7\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_154 {
  ...
  strings:
    ...
    $wide = "\xa8\x30\x00\xed\x30\x00\xc6\x30\x00\xa3\x30\x00\xba\x30\x00\xe0\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_155 {
  ...
  strings:
    ...
    $wide = "\xa8\x30\x00\xed\x30\x00\xc6\x30\x00\xa3\x30\x00\xc3\x30\x00\xaf\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_156 {
  ...
  strings:
    ...
    $wide = "\xb9\x30\x00\xa6\x30\x00\xa3\x30\x00\xf3\x30\x00\xac\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_157 {
  ...
  strings:
    ...
    $wide = "\xb9\x30\x00\xab\x30\x00\xfc\x30\x00\xc8\x30\x00\x6e\x30\x00\x2d\x4e\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_158 {
  ...
  strings:
    ...
    $wide = "\xc7\x30\x00\xfc\x30\x00\xc8\x30\x00\xec\x30\x00\xa4\x30\x00\xd7\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_160 {
  ...
  strings:
    ...
    $wide = "\xd7\x30\x00\xec\x30\x00\xa4\x30\x00\xdc\x30\x00\xfc\x30\x00\xa4\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_161 {
  ...
  strings:
    ...
    $wide = "\xda\x30\x00\xcb\x30\x00\xb9\x30\x00\xd0\x30\x00\xf3\x30\x00\xc9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_162 {
  ...
  strings:
    ...
    $wide = "\xdc\x30\x00\xfc\x30\x00\xa4\x30\x00\xba\x30\x00\xe9\x30\x00\xd6\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_163 {
  ...
  strings:
    ...
    $wide = "\xdc\x30\x00\xfc\x30\x00\xeb\x30\x00\x92\x30\x00\x74\x8e\x00\x8b\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_164 {
  ...
  strings:
    ...
    $wide = "\xdc\x30\x00\xfc\x30\x00\xeb\x30\x00\xae\x30\x00\xe3\x30\x00\xb0\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_165 {
  ...
  strings:
    ...
    $wide = "\xe9\x30\x00\xf3\x30\x00\xb8\x30\x00\xa7\x30\x00\xea\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_166 {
  ...
  strings:
    ...
    $wide = "\xb0\x65\x00\x57\x30\x00\x44\x30\x00\xdd\x30\x00\xeb\x30\x00\xce\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_167 {
  ...
  strings:
    ...
    $wide = "\xab\x30\x00\xfc\x30\x00\xde\x30\x00\xb9\x30\x00\xfc\x30\x00\xc8\x30\x00\xe9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_168 {
  ...
  strings:
    ...
    $wide = "\xaf\x30\x00\xf3\x30\x00\xcb\x30\x00\xea\x30\x00\xf3\x30\x00\xb0\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_169 {
  ...
  strings:
    ...
    $wide = "\xb2\x30\x00\xa4\x30\x00\xfb\x30\x00\xbb\x30\x00\xc3\x30\x00\xaf\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_170 {
  ...
  strings:
    ...
    $wide = "\xb9\x30\x00\xc8\x30\x00\xe9\x30\x00\xc3\x30\x00\xd7\x30\x00\xaa\x30\x00\xf3\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_171 {
  ...
  strings:
    ...
    $wide = "\xb9\x30\x00\xc8\x30\x00\xea\x30\x00\xc3\x30\x00\xd7\x30\x00\x87\x52\x00\x34\x58\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_172 {
  ...
  strings:
    ...
    $wide = "\xc9\x30\x00\xc3\x30\x00\xb0\x30\x00\xb9\x30\x00\xbf\x30\x00\xa4\x30\x00\xeb\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_173 {
  ...
  strings:
    ...
    $wide = "\xd0\x30\x00\xa4\x30\x00\xd6\x30\x00\xec\x30\x00\xfc\x30\x00\xbf\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_174 {
  ...
  strings:
    ...
    $wide = "\xd5\x30\x00\xa7\x30\x00\xc6\x30\x00\xa3\x30\x00\xc3\x30\x00\xb7\x30\x00\xe5\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_175 {
  ...
  strings:
    ...
    $wide = "\x36\x83\x00\x72\x82\x00\x6e\x30\x00\xb7\x30\x00\xe3\x30\x00\xef\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_176 {
  ...
  strings:
    ...
    $wide = "\xd0\x30\x00\xc3\x30\x00\xaf\x30\x00\xfb\x30\x00\xb9\x30\x00\xbf\x30\x00\xa4\x30\x00\xeb\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_177 {
  ...
  strings:
    ...
    $wide = "\xdd\x30\x00\xeb\x30\x00\xce\x30\x00\xb0\x30\x00\xe9\x30\x00\xd5\x30\x00\xa3\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_178 {
  ...
  strings:
    ...
    $wide = "\xb0\x30\x00\xeb\x30\x00\xfc\x30\x00\xd7\x30\x00\xfb\x30\x00\xbb\x30\x00\xc3\x30\x00\xaf\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_179 {
  ...
  strings:
    ...
    $wide = "\xb4\x30\x00\xfc\x30\x00\xeb\x30\x00\xc7\x30\x00\xf3\x30\x00\xb7\x30\x00\xe3\x30\x00\xef\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_180 {
  ...
  strings:
    ...
    $wide = "\xc6\x30\x00\xec\x30\x00\xd5\x30\x00\xa9\x30\x00\xf3\x30\x00\xbb\x30\x00\xc3\x30\x00\xaf\x30\x00\xb9\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_181 {
  ...
  strings:
    ...
    $wide = "\xc7\x30\x00\xa3\x30\x00\xfc\x30\x00\xd7\x30\x00\xfb\x30\x00\xb9\x30\x00\xed\x30\x00\xfc\x30\x00\xc8\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_182 {
  ...
  strings:
    ...
    $wide = "\xde\x30\x00\xb6\x30\x00\xfc\x30\x00\xfb\x30\x00\xd5\x30\x00\xa1\x30\x00\xc3\x30\x00\xab\x30\x00\xfc\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_183 {
  ...
  strings:
    ...
    $wide = "\xde\x30\x00\xb9\x30\x00\xbf\x30\x00\xfc\x30\x00\xd9\x30\x00\xfc\x30\x00\xb7\x30\x00\xe7\x30\x00\xf3\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_184 {
  ...
  strings:
    ...
    $wide = "\xa2\x30\x00\xb8\x30\x00\xa2\x30\x00\x6e\x30\x00\x4b\x30\x00\x8f\x30\x00\x44\x30\x00\x44\x30\x00\x73\x59\x00\x6e\x30\x00\x50\x5b\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_189 {
  ...
  strings:
    ...
    $wide = "\x4d\x30\x00\x93\x30\x00\x5f\x30\x00\x7e\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_190 {
  ...
  strings:
    ...
    $wide = "\xe4\x30\x00\xea\x30\x00\xde\x30\x00\xf3\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_192 {
  ...
  strings:
    ...
    $wide = "\xf4\x75\x00\x73\x59\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_196 {
  ...
  strings:
    ...
    $wide = "\x54\x98\x00\x04\x5c\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_197 {
  ...
  strings:
    ...
    $wide = "\xd1\x30\x00\xa4\x30\x00\xba\x30\x00\xea\x30\x00" nocase
  condition:
    any of them
}
...
rule content_ja_language_nsfw_199 {
  ...
  strings:
    ...
    $wide = "\xaf\x30\x00\xf3\x30\x00\xcb\x30\x00" nocase
  condition:
    any of them
}
